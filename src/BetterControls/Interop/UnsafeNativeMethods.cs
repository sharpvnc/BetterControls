...
namespace BetterControls
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        public static extern int SHGetStockIconInfo(NativeMethods.SHSTOCKICONID siid, NativeMethods.SHGSI uFlags, ref NativeMethods.SHSTOCKICONINFO psii);
        ...
        [DllImport("USER32.DLL", CharSet = System.Runtime.InteropServices.CharSet.Auto, EntryPoint = "SetClassLong")]
        [SuppressMessage("Microsoft.Portability", "CA1901:PInvokeDeclarationsShouldBePortable")]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SetClassLongPtr32(HandleRef hwnd, int nIndex, IntPtr dwNewLong);
        [SuppressMessage("Microsoft.Interoperability", "CA1400:PInvokeEntryPointsShouldExist")]
        [DllImport("USER32.DLL", CharSet = System.Runtime.InteropServices.CharSet.Auto, EntryPoint = "SetClassLongPtr")]
        [ResourceExposure(ResourceScope.None)]
        ...
        */
        ...
        [DllImport("SHELL32.DLL", CharSet = CharSet.Auto, EntryPoint = "ShellExecute", BestFitMapping = false)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport("USER32.DLL", ExactSpelling = true, EntryPoint = "CreateMenu", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.Process)]
        ...
        [DllImport("USER32.DLL", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SetWindowsHookEx(int hookid, GCHandle pfnhook, HandleRef hinst, int threadid);
        ...
        [DllImport("OLE32.DLL", ExactSpelling = true, CharSet = CharSet.Auto, SetLastError = true)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int OleUninitialize();
        [DllImport("USER32.DLL", EntryPoint = "ChildWindowFromPointEx", ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
...
*/
        ...
        [DllImport("KERNEL32.DLL", EntryPoint = "MapViewOfFile", ExactSpelling = true, CharSet = CharSet.Auto, SetLastError = true)]
        [ResourceExposure(ResourceScope.Process)]
        [SuppressMessage("Microsoft.Portability", "CA1901:PInvokeDeclarationsShouldBePortable")]
        ...
        [DllImport("KERNEL32.DLL", EntryPoint = "UnmapViewOfFile", ExactSpelling = true, CharSet = CharSet.Auto, SetLastError = true)]
        [ResourceExposure(ResourceScope.None)]
        private static extern bool IntUnmapViewOfFile(HandleRef pvBaseAddress);
        

        [DllImport("USER32.DLL", ExactSpelling = true, EntryPoint = "GetDCEx", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.Process)]
        ...
        [DllImport("USER32.DLL", ExactSpelling = true, EntryPoint = "DestroyMenu", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool DestroyMenu(HandleRef hMenu);
        
        [DllImport("USER32.DLL", ExactSpelling = true, EntryPoint = "CreatePopupMenu", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.Process)]
        ...
        [DllImport("USER32.DLL", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, IntPtr wParam, ref int lParam);
        ...
        */
        ...
        [DllImport("SHELL32.DLL", ExactSpelling = true, CharSet = CharSet.Ansi)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport("USER32.DLL", ExactSpelling = true, EntryPoint = "DestroyCursor", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        */
        ...
        internal class ThemingScope
        {
            ...
            public static IntPtr Activate()
            {
                ...
                if ((Application.VisualStyleState & System.Windows.Forms.VisualStyles.VisualStyleState.ClientAreaEnabled) != 0 && contextCreationSucceeded && OSFeature.Feature.IsPresent(OSFeature.Themes))
                {
                    if (!IsContextActive())
                    {
